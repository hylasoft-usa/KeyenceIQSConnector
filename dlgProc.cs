...
namespace Keyence2IQS
{
    ...
    /// </summary>
    public partial class dlgProc : Form
    {
        ...
        private void bnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a process and press OK to continue, or click Cancel to abort data conversion.");
            }
            else
            {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbList.Size = new System.Drawing.Size(260, 24);
            ...
            this.Text = "Keyence Process Selector";
            this.TopMost = true;
            this.Load += new System.EventHandler(this.dlgProc_Load);
            this.Resize += new System.EventHandler(this.frmMain_Resize);
            this.ResumeLayout(false);

        }

        private void dlgProc_Load(object sender, EventArgs e)
        {
